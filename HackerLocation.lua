...
Wall1.Parent = Folder
Wall1.Anchored = true
Wall1.Position = Vector3.new(1190.5, 571.678, -5357)
Wall1.Size = Vector3.new(1, 1052, 2048)
Wall1.CanCollide = true
local Wall2 = Instance.new("Part")
Wall2.Name = "Wall2"
Wall2.Parent = Folder
Wall2.Anchored = true
Wall2.Position = Vector3.new(873.5, 571.678, -4333.5)
Wall2.Size = Vector3.new(635, 1052, 1)
Wall2.CanCollide = true
local Wall3 = Instance.new("Part")
Wall3.Name = "Wall3"
Wall3.Parent = Folder
Wall3.Anchored = true
Wall3.Position = Vector3.new(-465, 571.678, -4333.5)
Wall3.Size = Vector3.new(784, 1052, 1)
Wall3.CanCollide = true
local Wall4 = Instance.new("Part")
Wall4.Name = "Wall4"
Wall4.Parent = Folder
Wall4.Anchored = true
Wall4.Position = Vector3.new(-856.5, 571.678, -5357)
Wall4.Size = Vector3.new(1, 1052, 2048)
Wall4.CanCollide = true
local Wall5 = Instance.new("Part")
Wall5.Name = "Wall5"
Wall5.Parent = Folder
Wall5.Anchored = true
Wall5.Position = Vector3.new(166.5, 571.678, -6381.5)
Wall5.Size = Vector3.new(2047, 1052, 1)
Wall5.CanCollide = true
local SignWall = Instance.new("Part")
SignWall.Name = "SignWall"
SignWall.Parent = Folder
SignWall.Anchored = true
SignWall.Position = Vector3.new(241, 726.178, -4333.5)
SignWall.Size = Vector3.new(632, 743, 1)
