...
local Window = Library:CreateWindow("GrannyHub".." - Weapon Fighting Simulator")

local LocalPlayer = Window:Page("LocalPlayer")

local Misc = Window:Page("Misc")

local filename = "DevilHub/WeaponFightingSimulator - 8554378337/Config.json"
...
makefolder("DevilHub");
makefolder("DevilHub/WeaponFightingSimulator - 8554378337");
