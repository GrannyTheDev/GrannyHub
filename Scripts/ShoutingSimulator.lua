...
local Window = Library:CreateWindow("GrannyHub".." - Shouting Simulator")
...
local filename = "DevilHub/ShoutingSimulator - 1304603528/Config.json"
...
makefolder("DevilHub");
makefolder("DevilHub/ShoutingSimulator - 1304603528");
...
function doShout()
spawn(function()
while getgenv().Settings.shout == true do
for i,v in pairs(getconnections(game:GetService("Players").LocalPlayer.PlayerGui.HUD.ShoutButtonHolder.ShoutButton.MouseButton1Click)) do
v.Function()
end
wait(0.1)
end
...
for i,v in pairs(getconnections(game:GetService("Players").LocalPlayer.PlayerGui.HUD.RebirthMenu.RebirthInfo.RebirthButton.MouseButton1Click)) do
v.Function()
end
wait(0.1)
end
...
local shout = AutoFarm:Toggle("Auto Shout", function(v)
getgenv().Settings.shout = v
Save()
if v then
doShout()
end
...
if getgenv().Settings.shout == true then
shout:ChangeState(true)
end
