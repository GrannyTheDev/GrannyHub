local Library = loadstring(game:HttpGet("https://GrannyTheDev.github.io/GrannyHub/Shit.lua"))()
   ...
   local Gui = Library:CreateWindow("GrannyHub".." - Muscle Legends")

   local LocalPlayer = Gui:Page("LocalPlayer")

   local Misc = Gui:Page("Misc")
   
local filename = "DevilHub/MuscleLegends - 3623096087/Config.json"
...
makefolder("DevilHub");
makefolder("DevilHub/MuscleLegends - 3623096087");
