...
local Window = Library:CreateWindow("GrannyHub".." - Hacker Tycoon")

local LocalPlayer = Window:Page("LocalPlayer")

local Misc = Window:Page("Misc")

local filename = "DevilHub/HackerTycoon - 7201996701/Config.json"
...
makefolder("DevilHub");
makefolder("DevilHub/HackerTycoon - 7201996701");
